...
@test "basectl repo init creates the standard repository baseline" {
    ...
    grep -Fq 'project_intake_gh "view issue" gh api' "$repo_dir/.github/workflows/project-intake.yml"
    grep -Fq "project_intake_is_project_transport_failure()" "$repo_dir/.github/workflows/project-intake.yml"
    grep -Fq "Falling back to the REST Projects API." "$repo_dir/.github/workflows/project-intake.yml"
    grep -Fq 'project_intake_gh "update REST Project fields" gh api --method PATCH' "$repo_dir/.github/workflows/project-intake.yml"
    ...
    grep -Fq 'graphql_set_single_select Priority "$expected_priority"' "$repo_dir/.github/workflows/project-intake.yml"
